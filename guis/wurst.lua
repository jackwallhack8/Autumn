...
local function downloadFile(path, func)
	...
	if not cached or cached == '' then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/jackwallhack8/Autumn/'..'refs/heads/main'..'/'..select(1, path:gsub('newvape/', '')), true) end)
