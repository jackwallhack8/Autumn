...
function mainapi:CreateGUI()
	...
	if isfile('newvape/profiles/commit.txt') then
		local _ok, _data = pcall(readfile, 'newvape/profiles/commit.txt')
		if _ok and type(_data) == 'string' and #_data >= 6 then
			_commitHash = _data:sub(1, 6)
		end
	end
	settingsversion.Text = 'Vape '..mainapi.Version..' '.._commitHash..' '
	...
	discordbutton.MouseButton1Click:Connect(function()
		...
		task.spawn(function()
			tooltip.Text = 'Copied!'
			setclipboard('https://discord.gg/8sjEsjFVZa')
		end)
	end)
...
scarcitybanner.Text = 'Join Autumn server to report any bugs or suggest any features! discord.gg/8sjEsjFVZa'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/jackwallhack8/Autumn/'..'refs/heads/main'..'/loader.lua', true))()
		end
	end,
